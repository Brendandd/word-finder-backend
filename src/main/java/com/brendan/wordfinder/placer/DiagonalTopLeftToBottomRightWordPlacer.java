 ...
 */
public class DiagonalTopLeftToBottomRightWordPlacer extends WordPlacer {
    public static String NAME = "Diagonal Top Left To Bottom Right Word Placer";
    
    private static final Logger logger = LoggerFactory.getLogger(DiagonalTopLeftToBottomRightWordPlacer.class);
