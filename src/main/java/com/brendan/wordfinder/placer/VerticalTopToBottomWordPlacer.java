...
public class VerticalTopToBottomWordPlacer extends WordPlacer {
    public static String NAME = "Vertical Top To Bottom Word Placer";
    
    private static final Logger logger = LoggerFactory.getLogger(VerticalTopToBottomWordPlacer.class);
